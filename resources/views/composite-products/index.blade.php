                ...
                <table id="product-table-view"
                    ...
                    @foreach($composites as $composite)
                        <tr data-product-id="2" role="row">
                            ...
                            <td data-id="2-code">{!! App\Product::find($composite->child)->name !!}</td>
                            <td data-id="2-name">{!! App\Product::find($composite->child)->description !!}</td>
                            <td data-id="2-actions"><a class="action-btn btn-app" href="{!! url('composite-products/'.$composite->child) !!}"
                                                       data-toggle="tooltip" data-placement="top" title=""
                                                       data-original-title="View Category"><i
                                            class="fa fa-folder-open-o green-font"></i></a>
                                <a class="action-btn btn-app" data-product-id="2" id="2-edit-action" href="{!! url('composite-products/'.$composite->child.'/edit') !!}"
                                   data-toggle="tooltip" data-placement="top" title=""
                                   data-original-title="Edit Category"><i class="fa fa-edit green-font"></i></a>

                                <form method="GET" action="{!! url('composite-products/'.$composite->child.'/delete') !!}" accept-charset="UTF-8" style="display:inline">
                                    <a class="action-btn btn-app"
                                       ...
                                       data-title="Delete a Composite Product"
                                       data-message="Are you sure you want to delete this composite product ?"
                                       data-original-title="Remove Composite Product"><i class="fa fa-times red-font"></i></a>
                                </form>
                            </td>
                        </tr>
                    @endforeach
...
@section('bread-crumb')
    ...
    <button data-ref="sub-menu-items" data-index="1" class="breadcrumb-btn font-blue" type="submit" id="1-bc">
            <span class="bc-img-wrap"><img class="breadcrumb-main-icon"
                ...
                class="breadcrumb-text">Composites</span></button>
