        ...
        <section class="box-body">
            <form class="row new-item-from-wrapper" role="form" method="post" id="new-prod-form"
                ...
                <section class="row form-group">
                    ...
                    <section class="col-md-6">{!! $parent->name !!}</section>
                    <section class="col-md-2"></section>
                </section>
                <section class="row form-group">
                    <section class="col-md-2"></section>
                    <section class="col-md-2"><label>Description</label></section>
                    <section class="col-md-6">{!! $parent->description !!}</section>
                    <section class="col-md-2"></section>
                </section>
                ...
                <section class="row form-group">
                    ...
                    <section class="col-md-6">
                        @foreach($children as $child)
                            {!! DB::table('products')->where('id','=',$child->child)->first()->name !!}<br>
                        @endforeach
                    </section>
                    <section class="col-md-2"></section>
                </section>
...
@section('bread-crumb')
    ...
    <button data-ref="sub-menu-items" data-index="2" class="breadcrumb-btn font-blue" type="submit" id="2-bc"><span
                class="breadcrumb-text">{!! $parent->name !!}</span></button>
