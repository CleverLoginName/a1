    ...
    <section class="box new-item-wrapper">
        ...
        <section class="box-body">
            <form class="row new-item-from-wrapper" role="form" method="post" id="new-prod-form"
                  enctype="multipart/form-data" novalidate="novalidate" action="{!! url('/composite-products') !!}">
                ...
                <section class="row form-group">
                    ...
                    <section class="col-md-2"><label>Composite Product</label></section>
                    <section class="col-md-6">
                        <select class="form-control required"
                                id="prod-frm-sub-cat" name="parent" aria-required="true"
                                aria-invalid="true">
                ...
                <section class="row form-group">
                    ...
                    <section class="col-md-6">
                        @foreach($products as $product)
                            {!! Form::checkbox('children[]', $product->id ,false) !!} {!! $product->name !!}<br>
                        @endforeach
                    </section>
                    <section class="col-md-2"></section>
                </section>
                ...
                <section class="row box-footer" id="form-footer">
                    ...
                    <a id="prod-frm-reset" href="{!! url('composite-products') !!}" class="btn add-item-btn" style="margin-right:10px;">Reset</a>
                </section>
            </form>
        </section>
    </section>
