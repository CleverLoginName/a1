    ...
    <section class="box new-item-wrapper">
        ...
        <section class="box-body">
            <form class="row new-item-from-wrapper" role="form" method="post" id="new-prod-form"
                  enctype="multipart/form-data" novalidate="novalidate" action="{!! url('/sub-categories/'.$subCategory->id) !!}">
                ...
                <section class="row form-group">
                    ...
                    <section class="col-md-6"><input class="form-control required" id="name"
                                                     name="name" aria-required="true" type="text" value="{!! $subCategory->name !!}"></section>
                    <section class="col-md-2"></section>
                </section>
                <section class="row form-group">
                    <section class="col-md-2"></section>
                    ...
                    <section class="col-md-6"><input class="form-control required" id="description"
                                                     name="description" aria-required="true" type="text" value="{!! $subCategory->description !!}"></section>
                    <section class="col-md-2"></section>
                </section>
                ...
                <section class="row box-footer" id="form-footer">
                    ...
                    <a id="prod-frm-reset" href="{!! url('sub-categories') !!}" class="btn add-item-btn" style="margin-right:10px;">Reset</a>
                </section>
            </form>
        </section>
    </section>
