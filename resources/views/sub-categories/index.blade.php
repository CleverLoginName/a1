                ...
                <table id="product-table-view"
                    ...
                    @foreach($subCategories as $sub_category)
                        <tr data-product-id="2" role="row">
                            ...
                            <td data-id="2-code">{!! $sub_category->name !!}</td>
                            <td data-id="2-name">{!! $sub_category->description !!}</td>
                            <td data-id="2-actions"><a class="action-btn btn-app" href="{!! url('sub-categories/'.$sub_category->id) !!}"
                                                       data-toggle="tooltip" data-placement="top" title=""
                                                       data-original-title="View Category"><i
                                            class="fa fa-folder-open-o green-font"></i></a>
                                <a class="action-btn btn-app" data-product-id="2" id="2-edit-action" href="{!! url('sub-categories/'.$sub_category->id.'/edit') !!}"
                                   data-toggle="tooltip" data-placement="top" title=""
                                   data-original-title="Edit Category"><i class="fa fa-edit green-font"></i></a>

                                <form method="GET" action="{!! url('sub-categories/'.$sub_category->id.'/delete') !!}" accept-charset="UTF-8" style="display:inline">
                                    <a class="action-btn btn-app"
                                       ...
                                       data-original-title="Remove Sub Category"><i class="fa fa-times red-font"></i></a>
                                </form>
                            </td>
                        </tr>
                    @endforeach
...
@section('bread-crumb')
    ...
    <button data-ref="sub-menu-items" data-index="1" class="breadcrumb-btn font-blue" type="submit" id="1-bc">
            <span class="bc-img-wrap"><img class="breadcrumb-main-icon"
                ...
                class="breadcrumb-text">Sub Categories</span></button>
