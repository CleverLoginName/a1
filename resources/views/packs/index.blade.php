                ...
                <table id="product-table-view"
                    ...
                    @foreach($packs as $pack)
                        <tr data-product-id="2" role="row">
                            ...
                            <td data-id="2-code">{!! $pack->name !!}</td>
                            <td data-id="2-name">{!! $pack->description !!}</td>
                            <td data-id="2-actions"><a class="action-btn btn-app" href="{!! url('packs/'.$pack->id) !!}"
                                                       data-toggle="tooltip" data-placement="top" title=""
                                                       data-original-title="View Category"><i
                                            class="fa fa-folder-open-o green-font"></i></a>
                                <a class="action-btn btn-app" data-product-id="2" id="2-edit-action" href="{!! url('packs/'.$pack->id.'/edit') !!}"
                                   data-toggle="tooltip" data-placement="top" title=""
                                   data-original-title="Edit Category"><i class="fa fa-edit green-font"></i></a>

                                <form method="GET" action="{!! url('packs/'.$pack->id.'/delete') !!}" accept-charset="UTF-8" style="display:inline">
                                    <a class="action-btn btn-app"
                                       ...
                                       data-title="Delete a Pack"
                                       data-message="Are you sure you want to delete this pack ?"
                                       data-original-title="Remove Pack"><i class="fa fa-times red-font"></i></a>
                                </form>
                            </td>
                        </tr>
                    @endforeach
